...
define('editor_tools/sally_client',['require','stomp','xml2json'],function(require) {
  ...
  return SallyClient = (function() {
    function SallyClient(config, msgHandler) {
      ...
      if (connections[config.stompUrl] != null) {
        ...
        this.stompClient.connect(config.stompUser, config.stompPassword, (function(frame) {
          return $(this.stompClient.connection_div).trigger("onConnected");
        }).bind(this));
      }
    }
    ...
    SallyClient.prototype.connect = function(interfaces, callback) {
      ...
      return $(client.connection_div).bind("onConnected", function(e) {
    ...
    SallyClient.prototype.send = function(destination, msg, callback, headers) {
      ...
      if (callback != null) {
        ...
        console.log(sub, this.stompClient.subscribe);
        if (headers == null) {
          headers = {};
        }
...
define('editor_tools/main',['require','editor_tools/scriptable_toolbar','editor_tools/interpretter','editor_tools/sally_client'],function(require) {
  var $, Interpretter, SallyClient, Toolbar, planetaryNS;
  if (typeof $ === "undefined" || $ === null) {
    $ = jQuery;
  }
  ...
  return {
    enrich_editor: function(editor, id, config) {
      ...
      handler = function(body, msg, response) {
        ...
        if ((body["GetSessionIDRequest"] != null) && body["GetSessionIDRequest"]["@xmlns"] === planetaryNS) {
          response({
            "GetSessionIDResponse": {
              "@xmlns": planetaryNS,
              "sessionid": "CbPJzjJT2nWJ4Rc87wag2geZzlhZ-RhgeCqf4MkOE7s"
            }
          });
        }
      ...
      ace.config.loadModule("ace/ext/language_tools", function(tools) {
        ...
        return tools.addCompleter({
          getCompletions: function(editor, session, pos, prefix, callback) {
            ...
            return _this.stompClient.send("/queue/mathhub.autocomplete_stex", replyHeaders(editor, responseCallback), JSON.stringify({
      ...
      sallyclient.connect(["planetaryclient"], function() {
