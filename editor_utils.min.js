...
define("editor_tools/stomp", function(){});

// Generated by CoffeeScript 1.6.3
var __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

define('editor_tools/main',['require','editor_tools/scriptable_toolbar','editor_tools/interpretter','editor_tools/stomp'],function(require) {
  ...
  return {
    stompMsgHandler: function(msg) {
      ...
      return this.editor.stompCorrelation[corrid](msg);
    },
    enrich_editor: function(editor, id, root_path, stompUrl, stompUser, stompPassword) {
      ...
      if (stompPassword == null) {
        stompPassword = "password";
      }
      this.stompClient = Stomp.client(stompUrl);
      this.stompClient.connect(stompUser, stompPassword, (function(frame) {
        var privateQueue;
