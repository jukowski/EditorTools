...
define('editor_tools/main',['require','editor_tools/scriptable_toolbar','editor_tools/interpretter','stomp'],function(require) {
  var $, Interpretter, Toolbar, connections, stompCorrelation, stompMsgHandler;
  if (typeof $ === "undefined" || $ === null) {
    $ = jQuery;
  }
  ...
  stompMsgHandler = function(msg) {
    ...
    if (this.stompCorrelation[corrid] == null) {
      return;
    }
    val = this.stompCorrelation[corrid](msg);
    if (val === true) {
      return;
    }
    return delete this.stompCorrelation[corrid];
  };
  return {
    enrich_editor: function(editor, id, config) {
      ...
      this.onConnected = function(client) {
        ...
        return $(client.connection_div).bind("onConnected", {
          editor: this.editor,
          stompClient: this.stompClient
        }, function(e) {
          var privateQueue, stompClient;
          ...
          return stompClient.subscribe(privateQueue, stompMsgHandler.bind(editor));
        });
      };
      ...
      this.onConnected(this.stompClient);
